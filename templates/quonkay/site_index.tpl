...
<ul>
{if {$SITE.gallery4}=="--- PLEASE SELECT ---"}
{assign var="SITE.gallery4" value=""}
{/if}
<li>
	<a rel="prettyPhoto[gallery]" href="assets/uploadedpics/{$SITE.gallery1|default:'sofa_logo.png'}" title="Seriously Sofas 1">
		<img src="assets/uploadedpics/thumbs/{$SITE.gallery1|default:'sofa_logo.png'}" alt="Seriously Sofas 1" width="174" height="94" />
		<span class="hoverlay"><span class="hoverzoom"></span></span>
	</a>
</li>
<li>
	<a rel="prettyPhoto[gallery]" href="assets/uploadedpics/{$SITE.gallery2|default: 'sofa_logo.png'}" title="Seriously Sofas 2">
		<img src="assets/uploadedpics/thumbs/{$SITE.gallery2|default:'sofa_logo.png'}" alt="Seriously Sofas 2" width="174" height="94" />
		<span class="hoverlay"><span class="hoverzoom"></span></span>
		</a>
</li>
<li>
	<a rel="prettyPhoto[gallery]" href="assets/uploadedpics/{$SITE.gallery3|default: 'sofa_logo.png'}" title="Seriously Sofas 3">
		<img src="assets/uploadedpics/thumbs/{$SITE.gallery3|default:'sofa_logo.png'}" alt="Seriously Sofas 3" width="174" height="94" />
		<span class="hoverlay"><span class="hoverzoom"></span></span>
	</a>
</li>
<li>
	<a rel="prettyPhoto[gallery]" href="assets/uploadedpics/{$SITE.gallery4|default: 'sofa_logo.png'}" title="Seriously Sofas 4">
		<img src="assets/uploadedpics/thumbs/{$SITE.gallery4|default:'sofa_logo.png'}" alt="Seriously Sofas 4" width="174" height="94" />
		<span class="hoverlay"><span class="hoverzoom"></span></span>
	</a>
</li>
<li>
	<a rel="prettyPhoto[gallery]" href="assets/uploadedpics/{$SITE.gallery5|default: 'sofa_logo.png'}" title="Seriously Sofas 5">
		<img src="assets/uploadedpics/thumbs/{$SITE.gallery5|default:'sofa_logo.png'}" alt="Seriously Sofas 5" width="174" height="94" />
		<span class="hoverlay"><span class="hoverzoom"></span></span>
	</a>
</li>
</ul>
...
<a href="{$SITE.visiturl}" target="_blank" class="actionbutton">Visit Our Site</a>
</div>
