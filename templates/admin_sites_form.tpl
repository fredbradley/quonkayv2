...
<br/>
<i><small>Important: No http:// or www. & lower case is preferable.</small></i>
</p>
...
<textarea class="text-input textarea" type="text" id="keywords" name="keywords" cols="30" rows="10">{$edit.keywords}</textarea>
<br/>
...
<br /><i><small>Maximum 550 Characters. Basic HTML tags allowed.&lt;p&gt; &lt;/p&gt; - Paragragh &lt;strong&gt; &lt;/strong&gt; - Bold, &lt;i&gt; &lt;/i&gt; - Italic, &lt;br/&gt;- Line Break</small></i>
</p>
...
<textarea class="text-input textarea wysiwyg" id="content_html" name="content_html" cols="70" rows="15">{$edit.content_html}</textarea>
...
<p>The following content is for the three 'boxes' that appear at the bottom of your website.</p>
<p><label>Box One Headline</label><input class="text-input large-input" id="box_one_headline" name="box_one_headline" value="{$edit.box_one_headline}" maxlength="20"/><br/><i><small>Max 20 characters.</small></i></p>
...
<p><label>Box Two Headline</label><input class="text-input large-input" id="box_two_headline" name="box_two_headline" value="{$edit.box_two_headline}" maxlength="20"/><br/><i><small>Max 20 characters.</small></i></p>
...
<p><label>Box Three Headline</label><input class="text-input large-input" id="box_three_headline" name="box_three_headline" value="{$edit.box_three_headline}" maxlength="20"/><br/><i><small>Max 20 characters.</small></i></p>
...
<p>
        ...
        <input type="text" class="text-input medium-input" name="visiturl" value="{$edit.visiturl}" /><br /><i><small>The Full URL (including http://) of the web page you want to be directed to when you click 'Visit This Site' at the bottom of your page.</small></i>
</p>
...
<br/>
<p><label>Analytics / Stats Code</label><textarea class="text-input large-input textarea" id="analytics" name="analytics" cols="10" rows="5">{$edit.analytics}</textarea><br /><i><small>Copy & Paste your statcounter/analytics code directly into this box.</small></i>
</p>
