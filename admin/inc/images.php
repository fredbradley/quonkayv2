...
if (isset($_GET['missioncomplete'])) {
$success = getMsg("success", "That file has been added to our list. You can now create a thumbnail of the image by selecting it from the dropdown menu below");
